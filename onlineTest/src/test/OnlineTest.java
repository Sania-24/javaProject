...
class OnlineTest extends JFrame implements ActionListener {
	//here will create jlabel, jradiobutton jbutton on jframe
    JLabel label;
    ...
    int m[]=new int[10];
    //inside constructor will intialize 
    OnlineTest(String s) {
    	super(s);
    	label=new JLabel();
    	add(label);
    ...
    //how to display questions with options on JFrame
